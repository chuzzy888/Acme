...
//             const postsArray = postDocs.docs.map(doc => ({ id: doc.id, ...doc.data() }));
//             setPosts(postsArray);
...
//                 <Link to='/'>
//                     <button className='text-xl'><MdArrowBackIos /></button>
//                 </Link>
//                 <h1 className="text-2xl font-bold">Blog Posts</h1>
//                 <Link to="/create" className=" text-gray-500  hover:bg-gray-200 px-4 py-2 font-black rounded-md"><SlNote /></Link>
//             </header>
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//                 {posts.map(post => (
//                     <div key={post.id} className="shadow-md p-4 ">
//                         <img src={post.imageUrl} alt={post.title} className="mb-4 w-full h-40 object-cover rounded-md" />
//                         <h2 className="text-xl font-bold mb-2">{post.title}</h2>
//                         <p className="text-white md:text-gray-500 mb-4 text-sm">{post.postContent.substring(0, 100)}...</p>
...
//                             <img
//                                 src="https://via.placeholder.com/40" // Placeholder image for the author's profile
                ...
                {loading ? (
                    ...
                    posts.map(post => (
                        <div key={post.id} className="shadow-md p-4">
                            <img src={post.imageUrl} alt={post.title} className="mb-4 w-full h-40 object-cover rounded-md" />
                            <h2 className="text-xl font-bold mb-2">{post.title}</h2>
                            <p className="text-gray-500 mb-4 text-sm">{post.postContent.substring(0, 100)}...</p>
                            <div className="flex items-center justify-between">
                                <Link to={`/posts/${post.id}`} className="text-blue-500 hover:underline">
                                    Read More
                                </Link>
